  ...
  return (
    <div>
      <div className="min-h-screen text-white relative">
        ...
        <div className={`min-h-screen bg-[#00000040] w-full flex flex-col justify-center items-center py-12 px-4 relative z-0 ${fontTitle.className}`}>
          ...
          <div className="md:w-3/4 lg:w-1/2 mt-5 flex items-center justify-center gap-5 px-4">
            <button 
              onClick={() => {
