      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
        ...
        <div className="w-full">
          ...
          <Link
            ...
            target="_blank"
            className="block w-full rounded-xl lg:rounded-2xl overflow-hidden shadow-xl lg:shadow-2xl border-2 lg:border-4 border-main/20 bg-white hover:shadow-2xl lg:hover:shadow-3xl transition-shadow duration-300"
          >
            <Image
              ...
              width={1000}
              height={450}
              className="object-cover w-full transition-transform duration-300 hover:scale-105 h-[300px] lg:h-[450px]"
              priority
            />
          </Link>
        </div>
        ...
        <div className="w-full">
          ...
          <div className="w-full rounded-xl lg:rounded-2xl overflow-hidden shadow-xl lg:shadow-2xl border-2 lg:border-4 border-main/20 bg-white">
            <iframe
